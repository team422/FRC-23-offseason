...
public final class Constants {
    ...
    public static final class ModuleConstants {
        ...
        public static final TunableNumber kDriveS = new TunableNumber("Drive kS", 0.2); //1
        public static final TunableNumber kDriveV = new TunableNumber("Drive kV", 3); //3
        public static final TunableNumber kDriveA = new TunableNumber("Drive kA", 1.5); //1.5

        public static final TunableNumber kTurningP = new TunableNumber("TurnP", 0.10); //0.10
        public static final TunableNumber kTurningI = new TunableNumber("Turn I", 0.00);
        public static final TunableNumber kTurningD = new TunableNumber("Turn D", 0.0); //0.005

        public static final TunableNumber kTurningPSim = new TunableNumber("TurningP Sim", 0.0); //5.5
